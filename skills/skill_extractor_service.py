...
class SkillExtractor:
    ...
    def __init__(self, 
                 taxonomy_path: str = 'skill_taxonomy.parquet',
                 variations_path: str = 'skill_variations.parquet',
                 canonical_embeddings_path: str = 'skill_canonical_embeddings.npy',
                 variations_embeddings_path: str = 'skill_variations_embeddings.npy',
